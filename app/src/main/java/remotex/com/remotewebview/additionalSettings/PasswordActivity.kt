...
import remotex.com.remotewebview.databinding.ActivityPasswordBinding
import remotex.com.remotewebview.databinding.CustomDefaultEmailSavedLayoutBinding
import remotex.com.remotewebview.databinding.CustomFailedLayoutBinding
import remotex.com.remotewebview.databinding.CustomSucessLayoutBinding
...
class PasswordActivity : AppCompatActivity() {
    ...
    private fun saveTooggleButton() {
        binding.apply {
            ...
            if (imagSwtichEnablOrDisbalePassowrd.isChecked) {
