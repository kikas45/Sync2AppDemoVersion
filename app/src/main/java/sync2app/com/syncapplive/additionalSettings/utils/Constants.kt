...
class Constants {
    companion object {
      ...
      //  const val LAUNCH_ONLINE_URL =  "https://cp.cloudappserver.co.uk/app_base/public/CLO/DE_MO_2021000/App/index.html"
        ...
        const val my_Saved_Downloads_Names = "my_Saved_Downloads_Names"
        ...
        const val SEND_SERVICE_NOTIFY = "SEND_SERVICE_NOTIFY"
        const val SEND_UPDATE_TIME_RECIEVER = "SEND_UPDATE_TIME_RECIEVER"
        ...
        const val HIDE_BOTTOM_BAR = "SHOW_BOTTOM_BAR"
        const val Enable_CacheMode = "Enable_CacheMode"
        const val SHOW_FLOATING_BAR = "SHOW_FLOATING_BAR"
        const val AUTO_HIDE_TOOL_BAR = "AUTO_HIDE_TOOL_BAR"
